...
var getWindow_1 = require("../utils/getWindow");
var findScrollableParent_1 = require("../utils/findScrollableParent");
var shouldWrapFocus_1 = require("../utils/shouldWrapFocus");
...
function _onKeyDownCapture(ev) {
    ...
    if (accessibility_1.getCode(ev) === accessibility_1.keyboardKey.Tab) {
        (_a = outerZones.getOutZone(getWindow_1.getWindow(ev.target))) === null || _a === void 0 ? void 0 : _a.forEach(function (zone) {
...
var FocusZone = /** @class */ (function (_super) {
    ...
    function FocusZone(props) {
        ...
        _this._onFocus = function (ev) {
            ...
            if (isImmediateDescendant) {
                ...
                while (parentElement && parentElement !== _this._root.current) {
                    ...
                    parentElement = dom_utilities_1.getParent(parentElement, ALLOW_VIRTUAL_ELEMENTS);
                }
            }
        ...
        _this._onMouseDown = function (ev) {
            ...
            while (target && target !== _this._root.current) {
                path.push(target);
                target = dom_utilities_1.getParent(target, ALLOW_VIRTUAL_ELEMENTS);
            }
            while (path.length) {
                target = path.pop();
        ...
        _this._onKeyDown = function (ev) {
            ...
            var doc = getDocument_1.getDocument(_this._root.current);
    ...
    FocusZone.prototype.componentDidMount = function () {
        ...
        // @ts-ignore
        this.windowElement = getWindow_1.getWindow(this._root.current);
        var parentElement = dom_utilities_1.getParent(this._root.current, ALLOW_VIRTUAL_ELEMENTS);
        var doc = getDocument_1.getDocument(this._root.current);
        // @ts-ignore
    ...
    FocusZone.prototype.focus = function (forceIntoFirstElement) {
        ...
        if (this._root.current) {
            ...
            if (!forceIntoFirstElement &&
                this._activeElement &&
                dom_utilities_1.elementContains(this._root.current, this._activeElement, ALLOW_VIRTUAL_ELEMENTS) &&
    ...
    FocusZone.prototype.evaluateFocusBeforeRender = function () {
        ...
        if (focusedElement !== this._root.current) {
            var shouldRestoreFocus = dom_utilities_1.elementContains(this._root.current, focusedElement, ALLOW_VIRTUAL_ELEMENTS);
    ...
    ev, useDefaultWrap) {
        ...
        do {
            element = (isForward ? focusUtilities_1.getNextElement(this._root.current, element) : focusUtilities_1.getPreviousElement(this._root.current, element));
            if (isBidirectional) {
                if (element) {
    ...
    FocusZone.prototype.moveFocusPaging = function (isForward, useDefaultWrap) {
        ...
        var scrollableParent = findScrollableParent_1.findScrollableParent(element);
        if (!scrollableParent) {
            return false;
        }
        var candidateDistance = -1;
    ...
    FocusZone.prototype.getOwnerZone = function (element) {
        var doc = getDocument_1.getDocument(this._root.current);
        var parentElement = dom_utilities_1.getParent(element, ALLOW_VIRTUAL_ELEMENTS);
        // @ts-ignore
    ...
    FocusZone.prototype.updateTabIndexes = function (onElement) {
        ...
        if (!element && this._root.current) {
            ...
            if (this._activeElement && !dom_utilities_1.elementContains(element, this._activeElement, ALLOW_VIRTUAL_ELEMENTS)) {
                this._activeElement = null;
            }
        }
    ...
    FocusZone.prototype.shouldWrapFocus = function (element, noWrapDataAttribute) {
        return !!this.props.checkForNoWrap ? shouldWrapFocus_1.shouldWrapFocus(element, noWrapDataAttribute) : true;
    };
    FocusZone.prototype.getDocument = function () {
        return getDocument_1.getDocument(this._root.current);
    };
    FocusZone.propTypes = {
