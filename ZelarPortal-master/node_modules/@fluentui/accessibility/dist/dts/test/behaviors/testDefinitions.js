...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var property = {};
        var expectedFirstKeyNumber = parameters.behavior(property).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
        var expectedSecondKeyNumber = parameters.behavior(property).keyActions[elementToPerformAction][action].keyCombinations[1].keyCode;
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var property = {};
        var expectedKeyNumber = parameters.behavior(property).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedResultOpenState = parameters.behavior(propsInOpenState).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedKeyNumberVertical = parameters.behavior(propertyVertical).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedKeyNumber = parameters.behavior(propertyHorizontal).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
        expect(expectedKeyNumber).toBe(keysAndAliases[key]);
    },
});
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedKeyNumberVertical = parameters.behavior(propertyHorizontal).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
        expect(expectedKeyNumberVertical).toBe(keysAndAliases[key]);
    },
});
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedKeyNumberVertical = parameters.behavior(propertyNoSubtree).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
        expect(expectedKeyNumberVertical).toBe(keysAndAliases[key]);
    },
});
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        ...
        var expectedKeyNumber = parameters.behavior(propertySubmenuOpened).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
        expect(expectedKeyNumber).toBe(keysAndAliases[key]);
        // when menuOpen == "false"
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var _a = __spreadArray([], parameters.props), action = _a[0], firstKey = _a[1], secondKey = _a[2], elementToPerformAction = _a[3];
        var propertySubmenuOpened = { menu: { items: [] }, hasMenu: true, menuOpen: true };
        var expectedFirstKeyNumber = parameters.behavior(propertySubmenuOpened).keyActions[elementToPerformAction][action].keyCombinations[0].keyCode;
