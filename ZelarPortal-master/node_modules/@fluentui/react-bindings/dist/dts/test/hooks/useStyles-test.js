...
var TestComponent = function (props) {
    var className = props.className, color = props.color, styles = props.styles, variables = props.variables, unstyled = props.unstyled;
...
describe('useStyles', function () {
    ...
    describe('unstyled', function () {
        it('applies "className" from options', function () {
            var wrapper = enzyme_1.shallow(React.createElement(TestComponent, { unstyled: true }));
            expect(wrapper.find('div').prop('className')).toContain('ui-test');
        });
        it('applies "className" from props', function () {
            var wrapper = enzyme_1.shallow(React.createElement(TestComponent, { unstyled: true, className: "foo" }));
            expect(wrapper.find('div').prop('className')).toContain('foo');
        });
        it('does not resolve styles', function () {
            var styles = jest.fn();
            enzyme_1.mount(React.createElement(TestComponent, { unstyled: true, color: "green" }), {
