...
var NavigationOrchestrator = /** @class */ (function () {
    ...
    NavigationOrchestrator.prototype._initializeSearchQuery = function (preloadedData) {
        ...
        if (preloadedData.clientSideApplicationId !== NavigationOrchestrator.classicPagesComponentId &&
            ...
            (Killswitches_1.Killswitches.isVivaHomeDisableSearchQueryKSActivated() ||
                preloadedData.clientSideApplicationId !== NavigationOrchestrator.spVivaHomeComponentId)) {
    ...
    NavigationOrchestrator.spVivaHomeComponentId = 'eb765a5a-9fec-4d59-8cca-6c623b450f0a';
