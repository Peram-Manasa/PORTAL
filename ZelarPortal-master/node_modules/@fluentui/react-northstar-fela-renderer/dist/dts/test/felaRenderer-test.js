...
function createSnapshot(component, theme) {
    ...
    ReactDOM.render(React.createElement(react_fela_1.RendererProvider, { renderer: felaRenderer },
        React.createElement(react_fela_1.ThemeProvider, { theme: __assign({ direction: 'ltr' }, theme) }, component)), div);
...
describe('felaRenderer', function () {
    ...
    test('marginLeft is rendered into marginLeft due to LTR', function () {
        var snapshot = createSnapshot(React.createElement(react_fela_1.FelaComponent, { style: { marginLeft: '10px' } }));
        expect(snapshot).toMatchSnapshot();
    });
    test('marginLeft is rendered into marginRight due to RTL', function () {
        var snapshot = createSnapshot(React.createElement(react_fela_1.FelaComponent, { style: { marginLeft: '10px' } }), { direction: 'rtl' });
        expect(snapshot).toMatchSnapshot();
    });
