...
exports.GlobeIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        var classes = _a.classes;
        return (React.createElement("svg", { role: "presentation", viewBox: "2 2 16 16", style: { overflow: 'visible' }, className: classes.svg },
