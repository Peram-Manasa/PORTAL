...
var FocusUtilities = require("../../src/FocusZone/focusUtilities");
...
describe('FocusTrapZone', function () {
    ...
    beforeEach(function () {
        ...
        Object.defineProperty(window, 'requestAnimationFrame', {
            writable: true,
            value: function (callback) { return callback(0); },
        });
    ...
    describe('multiple FocusZone mount/unmount', function () {
        it('remove aria-hidden from the 1st focusZone when the 2nd focusZone unmount', function () {
            var _a = test_utils_1.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var TestComponent = function () {
                var _a = React.useState(true), open = _a[0], setOpen = _a[1];
                return (React.createElement(React.Fragment, null,
                    ReactDOM.createPortal(React.createElement(React.Fragment, null, open && (React.createElement(react_bindings_1.FocusTrapZone, { id: "zone2" },
                        React.createElement("button", null, "zone2 button")))), document.body),
                    ReactDOM.createPortal(React.createElement("div", { id: "zone1-wrapper" },
                        React.createElement(react_bindings_1.FocusTrapZone, { id: "zone1" },
                            React.createElement("button", null, "zone1 button"))), document.body),
                    React.createElement("button", { id: "unmount-zone2-button", onClick: function () { return setOpen(false); } }, "button")));
            };
            ReactTestUtils.act(function () {
                ReactDOM.render(React.createElement(TestComponent, null), testContainer);
            });
            // initially both focusZone are mounted
            var zone1Wrapper = document.body.querySelector('#zone1-wrapper');
            expect(zone1Wrapper).toBeDefined();
            expect(zone1Wrapper.getAttribute('aria-hidden')).toBe('true');
            var zone2 = document.body.querySelector('#zone2');
            expect(zone2).toBeDefined();
            expect(zone2.getAttribute('aria-hidden')).toBe('true');
            // unmount zone2
            var unmountButton = testContainer.querySelector('#unmount-zone2-button');
            ...
            zone1Wrapper = document.body.querySelector('#zone1-wrapper');
            expect(zone1Wrapper).toBeDefined();
            expect(zone1Wrapper.getAttribute('aria-hidden')).toBeFalsy();
            removeTestContainer();
        });
    });
    describe('Restore focus on unmounting FTZ', function () {
        var TestComponent = function (_a) {
            var ftzProps = _a.ftzProps;
            var _b = React.useState(true), open = _b[0], setOpen = _b[1];
            return (React.createElement(React.Fragment, null,
                ReactDOM.createPortal(React.createElement(React.Fragment, null, open && (React.createElement(react_bindings_1.FocusTrapZone, __assign({ id: "zone" }, ftzProps),
                    React.createElement("button", null, "zone button")))), document.body),
                React.createElement("button", { id: "unmount-zone-button", onClick: function () { return setOpen(false); } }, "button")));
        };
        it.each(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      ftzProps                                 | preventScroll\n      ", "                             | ", "\n      ", " | ", "\n    "], ["\n      ftzProps                                 | preventScroll\n      ", "                             | ", "\n      ", " | ", "\n    "])), undefined, undefined, { preventScrollOnRestoreFocus: true }, true)('focus on previously focused element after unmounting the FTZ', function (_a) {
            var ftzProps = _a.ftzProps, preventScroll = _a.preventScroll;
            return __awaiter(void 0, void 0, void 0, function () {
                var _b, testContainer, removeTestContainer, focusAsyncSpy, unmountButton;
                return __generator(this, function (_c) {
                    _b = test_utils_1.createTestContainer(), testContainer = _b.testContainer, removeTestContainer = _b.removeTestContainer;
                    focusAsyncSpy = jest.spyOn(FocusUtilities, 'focusAsync');
                    ReactTestUtils.act(function () {
                        ReactDOM.render(React.createElement(TestComponent, { ftzProps: ftzProps }), testContainer);
                    });
                    // initially FTZ is mounted
                    expect(document.body.querySelector('#zone')).not.toBeNull();
                    unmountButton = testContainer.querySelector('#unmount-zone-button');
                    expect(unmountButton).not.toBeNull();
                    ReactTestUtils.Simulate.click(unmountButton);
                    // expect zone not is mounted, focus goes to button
                    expect(document.body.querySelector('#zone')).toBeNull();
                    expect(focusAsyncSpy).toHaveBeenCalledWith(expect.any(HTMLElement), { preventScroll: preventScroll });
                    removeTestContainer();
                    return [2 /*return*/];
                });
            });
