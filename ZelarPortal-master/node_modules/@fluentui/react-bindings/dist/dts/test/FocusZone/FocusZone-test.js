...
describe('FocusZone', function () {
    ...
    it('can use arrows vertically', function () {
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus }),
    ...
    it('skips subzone elements until manually entered', function () {
        ...
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus }),
            React.createElement(react_bindings_1.FocusZone, { direction: accessibility_1.FocusZoneDirection.horizontal, shouldEnterInnerZone: shouldEnterInnerZone },
                React.createElement("button", { id: "a" }, "a"),
                React.createElement("div", __assign({ id: "b", "data-is-sub-focuszone": true }, isFocusableProperty),
    ...
    it('skips child focusZone elements until manually entered', function () {
        ...
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus }),
            React.createElement(react_bindings_1.FocusZone, { direction: accessibility_1.FocusZoneDirection.horizontal, shouldEnterInnerZone: shouldEnterInnerZone },
                React.createElement("button", { id: "a" }, "a"),
                React.createElement(react_bindings_1.FocusZone, __assign({ direction: accessibility_1.FocusZoneDirection.horizontal, id: "b" }, isFocusableProperty),
                    React.createElement("button", { id: "bsub" }, "bsub")),
                React.createElement("button", { id: "c" }, "c"))));
        var focusZone = ReactDOM.findDOMNode(component).firstChild;
        var buttonA = focusZone.querySelector('#a');
    ...
    it('Changes our focus to the next button when we hit tab when focus zone allow tabbing', function () {
        ...
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus, onKeyDown: tabDownListener }),
            React.createElement(react_bindings_1.FocusZone, __assign({}, { handleTabKey: accessibility_1.FocusZoneTabbableElements.all, isCircularNavigation: true }),
                React.createElement("button", { id: "a" }, "a"),
                React.createElement("button", { id: "b" }, "b"),
                React.createElement("button", { id: "c" }, "c"))));
        var focusZone = ReactDOM.findDOMNode(component).firstChild;
    ...
    it('should stay in input box with arrow keys and exit with tab', function () {
        var tabDownListener = jest.fn();
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus, onKeyDown: tabDownListener }),
            React.createElement(react_bindings_1.FocusZone, __assign({}, { handleTabKey: accessibility_1.FocusZoneTabbableElements.inputOnly, isCircularNavigation: false }),
    ...
    it('focus should leave input box when arrow keys are pressed when tabbing is supported but shouldInputLoseFocusOnArrowKey callback method return true', function () {
        var tabDownListener = jest.fn();
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus, onKeyDown: tabDownListener }),
            React.createElement(react_bindings_1.FocusZone, __assign({}, {
    ...
    it('should force focus to first focusable element when FocusZone container receives focus and shouldFocusInnerElementWhenReceivedFocus is set to "true"', function () {
        ...
        var component = ReactTestUtils.renderIntoDocument(React.createElement("div", __assign({}, { onFocusCapture: onFocus }),
            React.createElement(react_bindings_1.FocusZone, { direction: accessibility_1.FocusZoneDirection.horizontal, shouldEnterInnerZone: shouldEnterInnerZone },
                React.createElement("button", { id: "a" }, "a"),
                React.createElement(react_bindings_1.FocusZone, __assign({ direction: accessibility_1.FocusZoneDirection.horizontal, id: "b", shouldFocusInnerElementWhenReceivedFocus: true }, isFocusableProperty),
                    React.createElement("button", { id: "bsub" }, "bsub")))));
        var focusZone = ReactDOM.findDOMNode(component).firstChild;
        var buttonA = focusZone.querySelector('#a');
        var divB = focusZone.querySelector('#b');
    ...
    describe('restores focus', function () {
        it('to the following item when item removed', function () {
            ...
            ReactDOM.render(React.createElement(react_bindings_1.FocusZone, null,
                React.createElement("button", { key: "a", id: "a", "data-is-visible": "true" }, "button a"),
                React.createElement("button", { key: "b", id: "b", "data-is-visible": "true" }, "button b"),
                React.createElement("button", { key: "c", id: "c", "data-is-visible": "true" }, "button c")), testContainer);
        ...
        it('can restore focus to the previous item when end item removed', function () {
            ...
            ReactDOM.render(React.createElement(react_bindings_1.FocusZone, null,
                React.createElement("button", { key: "a", id: "a", "data-is-visible": "true" }, "button a"),
                React.createElement("button", { key: "b", id: "b", "data-is-visible": "true" }, "button b")), testContainer);
    ...
    describe('parking and unparking', function () {
        ...
        function setup() {
            ...
            ReactDOM.render(React.createElement("div", null,
                ...
                React.createElement(react_bindings_1.FocusZone, { id: "fz" },
                    React.createElement("button", { key: "a", id: "a", "data-is-visible": "true" }, "button a"))), testContainer);
            buttonA = testContainer.querySelector('#a');
            buttonA.focus();
            // Render component without button A.
            ReactDOM.render(React.createElement("div", null,
                React.createElement("button", { key: "z", id: "z", "data-is-visible": "true" }),
                React.createElement(react_bindings_1.FocusZone, { id: "fz" })), testContainer);
        ...
        it('can move focus to container when last item removed', function () {
            var _a = setup(), removeTestContainer = _a.removeTestContainer, testContainer = _a.testContainer;
        ...
        it('removes focusability when moving from focused container', function () {
            ...
            testContainer.querySelector('#z').focus();
    ...
    it('Update tabIndex when FocusZone is changed before focused', function () {
        var _a = test_utils_1.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
        ...
        var ShowButton3Context = React.createContext(false);
        var Button3 = function () {
            var showButton3 = React.useContext(ShowButton3Context);
            return showButton3 ? (React.createElement("button", { className: "button-in-zone", id: "button-3" }, "added button 3")) : null;
        };
        var getDefaultTabbableElement = function () {
            var buttons = document.body.getElementsByClassName('button-in-zone');
            return buttons[buttons.length - 1];
        };
        var FocusZoneMemo = React.memo(function () { return (React.createElement(react_bindings_1.FocusZone, { shouldResetActiveElementWhenTabFromZone: true, defaultTabbableElement: getDefaultTabbableElement },
            React.createElement("button", { className: "button-in-zone" }, "button 1"),
            React.createElement("button", { className: "button-in-zone" }, "button 2"),
            React.createElement(Button3, null))); });
        var TestComponent = function () {
            var _a = React.useState(false), showButton3 = _a[0], setShowButton3 = _a[1];
            return (React.createElement(ShowButton3Context.Provider, { value: showButton3 },
                React.createElement("button", { id: "add-button", onClick: function () { return setShowButton3(true); } }, "Add"),
                React.createElement(FocusZoneMemo, null)));
        };
        ReactTestUtils.act(function () {
            ReactDOM.render(React.createElement(TestComponent, null), testContainer);
        });
        // Start test
        ...
        addButton.dispatchEvent(new KeyboardEvent('keydown', { which: accessibility_1.keyboardKey.Tab }));
