...
var FocusTrapZone = /** @class */ (function (_super) {
    ...
    function FocusTrapZone() {
        ...
        _this._releaseFocusTrapZone = function () {
            ...
            if (!lastActiveFocusTrap) {
                ...
                while (element.parentElement && element.parentElement !== (doc === null || doc === void 0 ? void 0 : doc.body)) {
    ...
    FocusTrapZone.prototype._focusAsync = function (element, options) {
        if (!this._isBumper(element)) {
            focusUtilities_1.focusAsync(element, options);
        }
    };
