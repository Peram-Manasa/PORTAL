...
var popupBehavior = function (props) {
    ...
    if (tabbableTriggerProps) {
        tabbableTriggerProps['aria-haspopup'] = ((_a = props.trigger) === null || _a === void 0 ? void 0 : _a.props.hasOwnProperty('aria-haspopup'))
            ? (_b = props.trigger) === null || _b === void 0 ? void 0 : _b.props['aria-haspopup']
            : 'dialog';
    ...
    return {
        attributes: {
            trigger: __assign({}, tabbableTriggerProps),
            popup: {
