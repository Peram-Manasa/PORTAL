...
var RendererProvider_1 = require("./RendererProvider");
...
function createFelaRenderer(options) {
    ...
    return function () {
        ...
        var Provider = function (props) { return (React.createElement(RendererProvider_1.RendererProvider, { renderer: felaRenderer, rehydrate: false, targetDocument: props.target }, props.children)); };
        return {
