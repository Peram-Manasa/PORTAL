...
var testInnerRef = function (Component) {
    ...
    var node = enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
...
describe('Ref', function () {
    ...
    describe('kind="find"', function () {
        ...
        it('returns "null" after unmount', function () {
            var innerRef = jest.fn();
            var wrapper = enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
        ...
        it('handles updates of props', function () {
            ...
            var wrapper = enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: initialRef },
                React.createElement("div", null)));
        ...
        it('resolves once on node/ref change', function () {
            ...
            expect(updatedRef).not.toHaveBeenCalled();
            jest.resetAllMocks();
            wrapper.setProps({ children: React.createElement("span", null), innerRef: updatedRef });
            expect(initialRef).not.toHaveBeenCalled();
        ...
        it('always returns "null" for react-test-renderer', function () {
            var innerRef = jest.fn();
            var ref = jest.fn();
            react_test_renderer_1.create(React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
    ...
    describe('kind="forward"', function () {
        it('works with "forwardRef" API', function () {
            ...
            var innerRef = React.createRef();
            enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
                React.createElement(fixtures_1.ForwardedRef, { ref: forwardedRef })));
        ...
        it('passes an updated node', function () {
            ...
            var wrapper = enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
                React.createElement(fixtures_1.ForwardedRef, { ref: forwardedRef, key: "first" })));
            expect(innerRef).toHaveBeenCalledWith(expect.objectContaining({ tagName: 'BUTTON' }));
    ...
    describe('kind="self"', function () {
        it('works with "forwardRef" API', function () {
            ...
            enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: outerRef },
                React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
                    React.createElement(fixtures_1.ForwardedRef, { ref: forwardedRef }))));
            expect(forwardedRef.current).toBeInstanceOf(Element);
            expect(innerRef.current).toBeInstanceOf(Element);
        ...
        it('passes an updated node', function () {
            ...
            var wrapper = enzyme_1.mount(React.createElement(react_component_ref_1.Ref, { innerRef: outerRef },
                React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
                    React.createElement("div", null))));
            expect(innerRef).toHaveBeenCalledWith(expect.objectContaining({ tagName: 'DIV' }));
            ...
            jest.resetAllMocks();
            wrapper.setProps({
                children: (React.createElement(react_component_ref_1.Ref, { innerRef: innerRef },
